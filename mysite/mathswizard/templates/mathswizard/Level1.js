...
Game.Level1.prototype = {
	...
	create:function(game){
		...
		this.createButton(game, answer, game.world.centerX, game.world.centerY + 200, 300, 100,
			function(){
				console.log('answer');
			});

		this.createButton(game, "Check", game.world.centerX, game.world.centerY + 300, 400, 300,
			function(){
